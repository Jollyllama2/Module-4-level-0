...
def draw():
    ...
    # *Hint* use the mousePressed variable
        ...
        # of Waldo to use in the code below
            if mouseX >510 and mouseX == 520 and  mouseY >390 and mouseY == 400:
                text ('You found Wally')
